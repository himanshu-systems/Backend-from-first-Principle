...
25. **WebRTC & Real-Time Media** - Peer-to-peer media: SDP, NAT traversal with STUN/TURN/ICE, DTLS-SRTP, RTP, congestion control, and the infrastructure behind it (TURN fleets, SFUs, simulcast, scaling).
